      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <a
              href="#contact"
              className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-400 to-green-500 hover:bg-slate-200 text-white inline-block text-center"
            >
              Hire Me
            </a>
            <a
              href="/resume/cv.txt"
              download
              className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple-400 to-green-500 hover:bg-slate-800 text-white mt-3 inline-block"
            >
